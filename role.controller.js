    ...
    static run(creep) {
        ...
        if (goal !== null && creep.room.name == goal.pos.roomName) {
            ...
            if (creep.pos.isNearTo(creep.room.controller)) {
                ...
                creep.moveMe(creep.room.controller, { segment: true, maxRooms: 1, reusePath: 50});
            }

        } else {
            creep.moveMe(goal !== null ? goal.pos : super.movement.getSourcePos(creep), { reusePath: 50, segment: true, ignoreCreeps: creep.isHome ? false : true });
        }
    }
}
