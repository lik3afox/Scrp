...
/*        if (creep.ticksToLive < 1000) {
        ...
        creep.memory.noHealing = true; // So it doesn't get healed by towers.
        ...
        if (super.movement.moveToDefendFlag3(creep)) {
            ...
            if (creep.carryTotal > 0 && creep.isHome) {
                ...
                return;
            } else if (!creep.isHome  && !creep.memory.noTombs && creep.carryTotal < creep.carryCapacity) {
