...
var _links = [
    // Spawn 1 room
    '599e13ba4820ce76f0fb3380','59a9d6e62bae572632b013d8',
...
class buildLink {
    ...
    static run() {
        ...
        sendEnergy(['599d67c618a08751a7262df9','599f88a92e6d2935543e1b55','59ab5b9062a124591c501f9b'], '599d511549eaf30b4769db20', 700);
        ...
        sendEnergy(['59a9b11438c396766a497cb4','59a17da37e58813734913135'], '599e1b793ffb5e7550c34732');

        sendEnergy('59a4a21ea43d2e7af216c1ba', '59a9e1bd0795aa50d7ded256');
        sendEnergy('59a9e1bd0795aa50d7ded256', '59a9b11438c396766a497cb4');

        sendEnergy('599e35c1296127177e64c747', '599e1b793ffb5e7550c34732');
        ...
        sendEnergy('59ab34fc406625094b86c77a', '59aadcceefa89764af662d60',700);
        sendEnergy('59aa685a7de64c7c32186eff', '59aa2a5bb5acfa10d8cae3ee',700);
        sendEnergy('59ab1746517a5b605d74a365', '59aadbeebf5816036ca1dfc1',700);
        sendEnergy(['59ad5febef19597918a206bd','59ab835078aa150c59d17611'], '59ab66cbea76c83e4369e9a6');
        sendEnergy('59abe6fb9560ec1a8f14232b', '59ab831de08945471b2f274e',700);
        sendEnergy('59adc88613e3c046855de3e2', '59ada0239cabec7faa49800f',700);
